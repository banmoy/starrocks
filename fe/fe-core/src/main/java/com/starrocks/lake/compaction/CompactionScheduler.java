        ...
        for (Iterator<Map.Entry<PartitionIdentifier, CompactionJob>> iterator = runningCompactions.entrySet().iterator();
            ...
            if (!job.transactionHasCommitted()) {
                ...
                if (errorMsg != null) {
                    ...
                    compactionManager.enableCompactionAfter(partition, Config.min_compaction_interval_ms_on_failure);
            ...
            if (job.transactionHasCommitted() && job.waitTransactionVisible(50, TimeUnit.MILLISECONDS)) {
                ...
                compactionManager.enableCompactionAfter(partition, Config.min_compaction_interval_ms_on_success * factor);
            }
        }
    ...
    private CompactionJob startCompaction(PartitionStatisticsSnapshot partitionStatisticsSnapshot) {
        ...
        try {
            ...
            if (table != null && table.getState() == OlapTable.OlapTableState.SCHEMA_CHANGE) {
                compactionManager.enableCompactionAfter(partitionIdentifier, Config.min_compaction_interval_ms_on_failure);
                return null;
            }
        ...
        long nextCompactionInterval = Config.min_compaction_interval_ms_on_success;
        ...
        try {
            ...
            nextCompactionInterval = Config.min_compaction_interval_ms_on_failure;
