...
public enum RuleType {
    ...
    TF_TVR_JOIN,
    TF_TVR_UNION_ALL,
    TF_OLAP_IVM_DELTA_AGGREGATE,
    TF_OLAP_IVM_DELTA_JOIN,
    TF_OLAP_IVM_DELTA_UNION,
    TF_OLAP_IVM_DELTA_INTERSECT,
    TF_OLAP_IVM_DELTA_EXCEPT,
    TF_OLAP_IVM_DELTA_WINDOW,
    TF_OLAP_IVM_VERSION_JOIN,
    TF_OLAP_IVM_VERSION_AGGREGATE,
    TF_OLAP_IVM_VERSION_WINDOW,
    TF_OLAP_IVM_VERSION_INTERSECT,
    TF_OLAP_IVM_VERSION_EXCEPT,
    TF_OLAP_IVM_VERSION_UNION,
    TF_OLAP_IVM_VERSION_PROJECT,
    TF_OLAP_IVM_VERSION_FILTER,
    TF_OLAP_IVM_VERSION_OLAP_SCAN,
