...
public class LakeTableAsyncFastSchemaChangeJobTest extends StarRocksTestBase {
    ...
    public void testHistorySchema() throws Exception {
        ...
        OlapTableHistorySchema historySchema1 = job1.getHistorySchema();
        ...
        OlapTableHistorySchema historySchema2 = job2.getHistorySchema();
        ...
        Assertions.assertFalse(job1.getHistorySchema().isExpired());
        ...
        Assertions.assertTrue(job2.getHistorySchema().isExpired());
        Assertions.assertNull(job2.getHistorySchema().getSchemaByIndexId(baseIndexId).orElse(null));
        Assertions.assertNull(job2.getHistorySchema().getSchemaBySchemaId(preAlterIndexMeta2.getSchemaId()).orElse(null));
    ...
    public void testReplayHistorySchema() throws Exception {
        ...
        Assertions.assertTrue(isSchemaMatch(db, table, Lists.newArrayList("c0", "c1")));
        OlapTableHistorySchema historySchema = job.getHistorySchema();
        ...
        Assertions.assertEquals(SchemaInfo.fromMaterializedIndex(table, preAlterIndexMeta),
                SchemaInfo.fromMaterializedIndex(restoredTable, restoredTable.getIndexMetaByIndexId(baseIndexId)));
        ...
        Assertions.assertEquals(SchemaInfo.fromMaterializedIndex(table, table.getIndexMetaByIndexId(baseIndexId)),
                SchemaInfo.fromMaterializedIndex(restoredTable, restoredTable.getIndexMetaByIndexId(baseIndexId)));
        ...
        OlapTableHistorySchema restoredHistorySchema = fseJob.getHistorySchema();
