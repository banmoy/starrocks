...
public class IvmDeltaExceptRuleTest {
    @Test
    ...
    private SetRewriteContext<LogicalExceptOperator> createExceptRewriteContext(OlapTable leftTable,
        ...
        LogicalExceptOperator except = new LogicalExceptOperator.Builder()
                ...
                .build();
        OptExpression deltaExceptExpr = OptExpression.create(
    ...
    private void assertRewriteResult(List<OptExpression> result, OptExpression deltaExpr) {
        ...
        Assertions.assertTrue(oldProducer.getOp() instanceof LogicalExceptOperator);
        ...
        Assertions.assertTrue(newProducer.getOp() instanceof LogicalExceptOperator);
