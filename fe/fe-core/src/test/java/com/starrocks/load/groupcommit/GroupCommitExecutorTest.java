...
public class GroupCommitExecutorTest extends GroupCommitTestBase {
    ...
    public void setup() throws Exception {
        label = "group_commit_" + DebugUtil.printId(UUIDUtil.toTUniqueId(UUID.randomUUID()));
    ...
    public void testLoadSuccess() throws Exception {
        GroupCommitLoadExecutor executor = new GroupCommitLoadExecutor(
    ...
    private void testLoadFailBase(
            GroupCommitLoadExecutor executor, Exception expectedException, TransactionStatus expectedTxnStatus) {
        executor.run();
