...
public:
    ...
    void group_commit_load(google::protobuf::RpcController* controller, const PGroupCommitLoadRequest* request,
                           PGroupCommitLoadResponse* response, google::protobuf::Closure* done) override;
